...
class AssetAdminServiceTest {
    ...
    <I extends AssetCreateDto & IpAddressAwareDto, R extends AssetDto & IpAddressAwareDto> void sampleCreate(I input,
            Class<R> resultClass) {
    ...
    static Stream<Arguments> validCreateParams() {
        ...
        sosWoIp2.stationId = "SOS-FOO-003";
        ...
        return Stream.of(
                ...
                argumentSet("MeteoSensorAssetCreateDto without ipAddress (null must not collide)", metWoIp2,
